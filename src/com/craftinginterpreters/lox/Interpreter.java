...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        for (Stmt.Function static_method : stmt.static_methods) {
            LoxFunction function = new LoxFunction(static_method, environment,
                    false);
            static_methods.put(static_method.name.lexeme, function);
        }
        ...
        LoxClass klass = new LoxClass(stmt.name.lexeme, (LoxClass)superclass, methods, static_methods, getters);
        if (superclass != null) {
    ...
    public Void visitWhileStmt(Stmt.While stmt) {
        while (!breakflag && isTruthy(evaluate(stmt.condition))) {
            execute(stmt.body);
        }
        breakflag = false;
        return null;
